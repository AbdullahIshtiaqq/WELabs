$(document).ready(function (){
    ...
    $("#hirePhotographer").on('click',function (){
       var formdata = $("#id").val();
       if(formdata=="")
       {
       ...
       $.ajax({
          ...
          success : function (response){
              ...
              else
              {
                  ...
                  sessionStorage.setItem('chargesPerHour',response.hourlyRate);
                  sessionStorage.setItem('mobileNo',response.mobileNo);
                  sessionStorage.setItem('name',response.name);
                  window.location.href='/bookev/hire/photographer';
              }
