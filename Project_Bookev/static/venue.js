       ...
       $.ajax({
          ...
          success : function (response){
              ...
              else
              {
                  ...
                  sessionStorage.setItem('chargesPerHour',response.charges);
                  sessionStorage.setItem('mobileNo',response.mobileNo);
                  sessionStorage.setItem('name',response.name);
                  sessionStorage.setItem('capacity',response.capacity);
                  window.location.href='/bookev/book/venue';
              }
